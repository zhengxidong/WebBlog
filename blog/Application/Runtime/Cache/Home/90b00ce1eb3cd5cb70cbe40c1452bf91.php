...
<article class="blogs">
<h1 class="t_nav"><span>“慢生活”不是懒惰，放慢速度不是拖延时间，而是让我们在生活中寻找到平衡。</span><a href="/" class="n2">慢生活</a></h1>
...
<div class="news">
    <div class="news_right">
        ...
        <ul class="rank">
            <?php if(is_array($article)): foreach($article as $key=>$value): ?><li><i class="fa fa-bookmark-o"></i>
              <a href="/Home/NewList/newdetail/id/<?php echo ($value['id']); ?>" title="<?php echo ($value['articletitle']); ?>" target="_blank"><?php echo ($value['articletitle']); ?></a>
    ...
    <div class="news_right news_ph">
        ...
        <ul class="paih">
            <?php if(is_array($articleph)): foreach($articleph as $key=>$value): ?><li><i class="fa fa-bookmark-o"></i><a href="/Home/NewList/newdetail/id/<?php echo ($value['id']); ?>" title="<?php echo ($value['articletitle']); ?>" target="_blank"><?php echo ($value['articletitle']); ?></a>
          </li><?php endforeach; endif; ?>
        </ul>
    </div>
    </div>
